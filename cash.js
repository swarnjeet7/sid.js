...
(function () {
      ...
      fn[name] = function (includeMargins) {
        ...
        return (
          ...
          (includeMargins && outer
            ? computeStyleInt(this[0], "margin" + (i ? "Top" : "Left")) +
              computeStyleInt(this[0], "margin" + (i ? "Bottom" : "Right"))
            : 0)
        );
      };
    });
  ...
  each(["Width", "Height"], function (index, prop) {
    ...
    fn[propLC] = function (value) {
      ...
      if (!arguments.length) {
        ...
        if (isDocument(this[0])) return getDocumentDimension(this[0], prop);
        return (
          this[0].getBoundingClientRect()[propLC] -
        ...
        var finalCallback = function finalCallback(event) {
          ...
          if (
            ...
            ((isEventFocus && (event.target !== ele || event.___ot === name)) ||
              (isEventHover &&
                event.relatedTarget &&
                ele.contains(event.relatedTarget)))
          )
            return;
          var thisArg = ele;
  ...
  fn.position = function () {
    ...
    if (!isFixed) {
      ...
      while (
        (offsetParent === doc_1.body ||
          offsetParent === doc_1.documentElement) &&
        computeStyle(offsetParent, "position") === "static"
      ) {
  ...
  function insertElement(anchor, target, left, inside, evaluate) {
    if (inside) {
      ...
      anchor.parentNode.insertBefore(
        target,
        left ? anchor : anchor.nextSibling
      );
    }
  ...
  fn.not = function (comparator) {
    ...
    return this.filter(function (i, ele) {
      return (
        (!isString(comparator) || isElement(ele)) && !compare.call(ele, i, ele)
      );
    });
  };
  ...
  fn.parents = function (comparator, _until) {
    return filtered(
      cash(unique(pluck(this, "parentElement", true, _until))),
      comparator
    );
  };
